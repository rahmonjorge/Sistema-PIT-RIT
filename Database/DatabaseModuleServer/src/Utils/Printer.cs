...
namespace HTools
{
    ...
    public static class Printer
    {
        ...
        public static void LogRequest(object request, string host, string method)
        {
            BlueLn($"REQUEST RECEIVED AT {DateTime.Now}");
            BlueLn($"Method: '{method}, Host: {host}, Content: {request.ToString()}'");
        }

...
<div class="flex w-[304px] flex-col items-center py-10">
	...
	<span class="mt-2 text-xl">Agradecemos o feedback!</span>
	<button
		type="button"
		on:click={() => dispatch('feedBackRestartRequested')}
		class="mt-6 rounded-md border-transparent bg-zinc-100 py-2 px-6 text-sm leading-6 transition-colors hover:bg-zinc-200 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-white "
	>
		Quero enviar outro
	</button>
</div>
